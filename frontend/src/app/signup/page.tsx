...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#fff5f5] via-[#fff0f3] to-[#ffeef2] flex items-center justify-center px-4 relative overflow-hidden">
      {/* Blobs */}
      <div className="absolute top-[-80px] left-[-80px] w-[300px] h-[300px] rounded-full bg-pink-200/40 blur-[60px]" />
      <div className="absolute bottom-[-60px] right-[-60px] w-[250px] h-[250px] rounded-full bg-rose-200/30 blur-[50px]" />
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-rose-100 rounded-2xl p-8 shadow-xl shadow-rose-100/30">
          <h2 className="text-2xl font-extrabold text-rose-900 mb-1">Create account 💗</h2>
          <p className="text-sm text-rose-400/50 mb-6">Start monitoring your relationship health</p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs font-bold text-rose-500/60 uppercase tracking-wider mb-2 block">Full Name</label>
                <input
                  type="text"
                  value={fullName}
              ...
              <div>
                <label className="text-xs font-bold text-rose-500/60 uppercase tracking-wider mb-2 block">Username</label>
                <input
                  type="text"
                  value={username}
                  onChange={(e) => setUsername(e.target.value)}
                  placeholder="veeral_s"
                  className="w-full px-4 py-3 rounded-xl bg-rose-50/50 border border-rose-100 text-rose-900 placeholder-rose-300 text-sm focus:outline-none focus:border-rose-400 focus:ring-2 focus:ring-rose-200 transition-all"
                  required
                />
              </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="veeral@example.com"
                className="w-full px-4 py-3 rounded-xl bg-rose-50/50 border border-rose-100 text-rose-900 placeholder-rose-300 text-sm focus:outline-none focus:border-rose-400 focus:ring-2 focus:ring-rose-200 transition-all"
                required
              />
            </div>
            ...
            <div>
              <label className="text-xs font-bold text-rose-500/60 uppercase tracking-wider mb-2 block">Confirm Password</label>
              <input
                type="password"
